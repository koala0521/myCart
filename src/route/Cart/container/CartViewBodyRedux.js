...
const UPDATE_CART_COUNT  = 'UPDATE_CART_COUNT/shopping-cart/cartView';
...
const updateCartCountAction = ( skuId ,count=1)=> (dispatch, getState) => {
    ...
    setStorageITEM(storageITEM);
    dispatch( {type:UPDATE_CART_COUNT,payload:cartInfo});
}
...
const removeFromCartAction = (skuIds=[])=>(dispatch, getState)=>{
    ...
    dispatch({type:'REMOVE_FROM_CART', payload:cartInfo});
